...
class Doctor(models.Model):
    ...
    signature = models.TextField(blank=True)  # base64 or text
...
class Patient(models.Model):
    ...
    age_unit = models.CharField(max_length=10, default='Years', choices=[('Years', 'Years'), ('Months', 'Months'), ('Days', 'Days')])
...
class TemplateMedicine(models.Model):
    ...
    timing = models.CharField(max_length=20, choices=TIMING_CHOICES, default='After Meal')
...
class PrescriptionMedicine(models.Model):
    TIMING_CHOICES = TemplateMedicine.TIMING_CHOICES
    FREQUENCY_CHOICES = TemplateMedicine.FREQUENCY_CHOICES
